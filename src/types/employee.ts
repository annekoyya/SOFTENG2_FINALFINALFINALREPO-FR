...
export function useEmployees() {
  ...
  return {
    employees, archivedEmployees, selectedEmployee, departments,
    jobCategories, salaryMap, pagination, isLoading, error,
    fetchEmployees, fetchArchived, fetchEmployee,
    createEmployee, updateEmployee, archiveEmployee,
    restoreEmployee, purgeEmployee, updateRole,
    fetchDepartments, fetchJobCategories, fetchSalaryMap,
